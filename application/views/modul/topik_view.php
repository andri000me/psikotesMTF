                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Jumlah Subtes</label>
                                <input type="number" class="form-control" id="tambah-subtest" name="tambah-subtest" placeholder="Total Subtest" value="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Jumlah Subtest</label>
                                <input type="number" class="form-control" id="edit-subtest" name="edit-subtest" placeholder="Total Subtest">
                            </div>
