...
<section class="content-header">
	<h1>
		Mengelola Soal Instruksi
		<small>Mengelola Instruksi soal berdasarkan topik</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url() ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Instruksi Soal</li>
	</ol>
</section>
...
<section class="content">
        ...
        <div class="col-xs-12">
                <div class="box box-primary">
                    <?php echo form_open_multipart($url.'/tambah','id="form-tambah" class="form-horizontal"'); ?>
                        <div class="box-header with-border">
                            <div class="box-title">Mengelola Instruksi Soal <span id="judul-tambah-soal"></span></div>
                        </div><!-- /.box-header -->
    ...
    <div class="row">
        <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="box-title">Daftar Instruksi Soal <span id="judul-daftar-soal"></span></div>
