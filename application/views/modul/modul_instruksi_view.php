        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-footer">
                    <p>Pilih terlebih dahulu Topik yang akan digunakan sebelum menambah atau mengubah soal --- <?php echo $zzzzzzz  ?></p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" name="tambah-idsoal" id="tambah-idsoal" >
                                </div>
                            </div>
...
<script lang="javascript">
	function refresh_topik(){
        ...
        var valueSelected = $("#topik option:selected").attr("value");
        var idSelected = $("#topik option:selected").attr("id");
        $('#judul-daftar-soal').html(judul);
        document.getElementById('tambah-idsoal').value= idSelected;
        // alert(idSelected);
        // $.removeCookie("profile_viewer_uid");

        document.cookie = 'profile_viewer_uid='+idSelected+'; expires=Wed, 1 Jan 2070 13:47:11 UTC; path=/'

         <?php
         $valueSelecte = $_COOKIE['profile_viewer_uid'];
         ?>
