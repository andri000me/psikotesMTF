    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-mini"><b style="color:#222d32">MTF</b></span>
          <!-- logo for regular state and mobile devices -->
          <!-- <span class="logo-lg"><b style="color:#222d32">Mandiri Tunas Finance</b></span> -->
          <img src="<?php echo base_url(); ?>public/plugins/adminlte/img/mtfLogo.png" height="40" width="100" style="margin-top: -6px;" alt="Italian Trulli">
        </a>
