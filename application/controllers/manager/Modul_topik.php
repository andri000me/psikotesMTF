...
class Modul_topik extends Member_Controller {
    ...
    function tambah(){
		...
		$this->form_validation->set_rules('tambah-subtest', 'Subtest','required|strip_tags');
        ...
        if($this->form_validation->run() == TRUE){
			...
			$data['topik_aktif'] = 1;
			$data['topik_subtest'] = $this->input->post('tambah-subtest', true);
    ...
    function edit(){
		...
		$this->form_validation->set_rules('edit-subtest', 'Subtest','required|strip_tags');
        ...
        if($this->form_validation->run() == TRUE){
            ...
            if($pilihan=='hapus'){//hapus
				...
				$data['topik_subtest'] = $this->input->post('edit-subtest', true);
