...
class Tes_report extends Member_Controller {
	private $kode_menu = 'tes-report';
	private $kelompok = 'tes';
	private $url = 'manager/tes_report';
    ...
    public function index($page=null, $id=null){
        ...
        $tanggal_awal = date('Y-m-d H:i', strtotime('- 30 days'));
        ...
        $this->template->display_admin($this->kelompok.'/tes_hasil_report_view.', 'Hasil Tes', $data);
    }
